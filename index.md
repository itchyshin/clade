...
against the primary literature (26 of 32 auditable scenarios pass; 6
...
See the [Parameter
Reference](https://itchyshin.github.io/clade/articles/parameter-reference.html)
article for the complete parameter list.
...
The six 🟠 scenarios (mating-systems, group-defense, plasticity, Baldwin
effect, predation-neural, stress-hypermutation) have honestly-documented
kernel or ecology limitations. The ledger was confirmed end-to-end under
the 0.5.10 real-diploid-sex kernel — see
...
findings](https://github.com/itchyshin/clade/blob/main/dev/audit/fidelity/CRASH_AUDIT_FINDINGS.md)

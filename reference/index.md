...
- [`fast_specs()`](fast_specs.md) : Fast-generation specs for
  evolutionary scenarios
- [`slow_specs()`](slow_specs.md) : Slow-generation specs for long-lived
  organism scenarios
...
- [`species_tree()`](species_tree.md) : Reconstruct a species tree from
  a logged simulation
- [`viability_report()`](viability_report.md) : Viability report for an
  evolutionary-audit run

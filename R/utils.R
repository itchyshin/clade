...
.SPEC_GROUPS <- list(
  "Grid & population"     = c("grid_rows", "grid_cols", "toroidal",
                               "random_tick_order", "max_agents_per_cell",
  ...
  "Brain size evolution"  = c("brain_size_evolution", "brain_size_init_mean",
                               ...
                               "brain_size_extra_grass_exponent"),
  ...
  "Scavenging"            = c("scavenging", "carrion_decay", "carrion_max",
                               "carrion_fraction", "carrion_decay_rate",
                               "carrion_eat_gain",
                               "carrion_transmission_prob",
                               "scavenge_gain"),
  "ANN regularisation"    = c("ann_regularization", "ann_l1_coefficient",
                               "ann_l0_coefficient"),
  ...
  "Logging & search"      = c("log_genomes", "log_deaths", "log_freq",
                               "verbose_julia")
)

...
test_that("default_specs() contains all required parameters", {
  ...
  required <- c(
    ...
    "habitat_preference_evolution", "habitat_preference_init_mean",
    "habitat_preference_mutation_sd", "habitat_preference_min",
    "habitat_preference_max", "habitat_preference_strength", "habitat_move_cost",
    "group_defense", "group_defense_radius", "group_defense_strength",
    "seasonal_amplitude", "season_length", "winter_death_prob",
    "parental_care", "care_cost_per_tick", "feeding_rate",
    "juvenile_independence_age", "juvenile_independence_energy",
    "cooperative_breeding", "helper_min_energy", "helper_transfer",
    "helper_kin_threshold", "helper_tendency_init_mean", "helper_tendency_mutation_sd",
    "signal_dims", "signal_cost", "mate_choice_mode", "mate_choice_strength",
    "speciation", "isolation_threshold", "speciation_cluster_interval",
    "n_predators_init", "predator_energy_init", "predator_live_energy",
    "predator_attack_strength", "predator_energy_gain",
    "predator_min_repro_energy", "predator_min_repro_age",
    "predator_mutation_sd", "predator_max_agents",
    "mimicry", "toxicity_cost_per_tick", "toxin_dose",
    "signal_memory_rate", "avoid_threshold",
    "toxicity_init_mean", "toxicity_mutation_sd",
    "phenotypic_plasticity", "plasticity_sense_radius",

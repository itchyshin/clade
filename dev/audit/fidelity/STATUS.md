...
| s-mating-systems                      | Maynard Smith 1978; Hamilton 1980             | 🟠 passed-consistent (2026-04-18 0.5.13, 2×2 Red Queen differential at 32 seeds: RQ_benefit(n_agents) = +3.08 ± 4.05 at t = +0.76; RQ_benefit(diversity) = +0.041 ± 0.030 at t = +1.36. Both direction Hamilton-correct; sex-parasite-cost (+3.3 agents) is less than half of asex-parasite-cost (+6.4 agents). Single-factor sex-vs-asex is overwhelmed by cost-of-sex: 16-20/32 sex seeds crash even with equalised cost, so single-factor Δn(sex − asex) ≈ −85 at t = −17 is structural (2-parent bottleneck) not Red-Queen-related. Hamilton-1980 *mechanism* is present in clade; full promotion requires either ~60-seed 2×2 retry OR sex-cost kernel redesign to raise sex viability above the "2-parent filter" floor. | [mating_systems.md](mating_systems.md)              | pending |

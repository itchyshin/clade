...
| s-plasticity                          | Pigliucci 2001; DeWitt & Scheiner 2004        | ✅ passed (2026-04-18 0.5.18, new `seasonal_spatial_bias` kernel spec creates fluctuating-selection regime where the optimal foraging direction flips between seasons. 16 seeds × 3 conditions × 2000 ticks at default_specs: Δsigma(flipping − stable) = +0.0227 ± 0.0049, t = +4.58 PASS. Uniform stressor (amp_only) produces no plasticity signal — only phenotype-dependent fluctuating selection works.) | [plasticity_baldwin_promotion.md](plasticity_baldwin_promotion.md) | pending |
| s-baldwin                             | Hinton & Nowlan 1987                          | ✅ passed (2026-04-18 0.5.18, same `seasonal_spatial_bias` kernel spec. Same 3×16 audit shows Δsigma(flipping − amp_only) = +0.0186 ± 0.0040, t = +4.60 PASS. Hinton-Nowlan canonical prediction confirmed: plastic (high-sigma) agents outperform canalized ones when the optimum flips, producing the expected rise in mean_prior_sigma under fluctuating selection.) | [plasticity_baldwin_promotion.md](plasticity_baldwin_promotion.md) | pending |

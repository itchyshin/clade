...
| s-plasticity                          | Pigliucci 2001                                | 🟠 passed-consistent (2026-04-18 deeper diagnosis: mate-finding failure silently converts diploid offspring to effectively-haploid → sigma pegged at bnn_sigma_init = 0.5; correct metric is mean_prior_sigma not mean_plasticity; 0.5.9 added `self_fertilization_fallback` spec as fix but selfing inbreeds populations; full promotion requires broader mate-finding or less-inbred selfing) | [plasticity.md](plasticity.md)                      | pending |
| s-baldwin                             | Hinton & Nowlan 1987                          | 🟠 passed-consistent (same kernel limit as s-plasticity: mate-finding failure pegs BNN sigma at bnn_sigma_init regardless of environment; 0.5.9 added `self_fertilization_fallback` but selfing is too inbred to reliably test canonical Baldwin canalization) | [baldwin.md](baldwin.md)                            | pending |

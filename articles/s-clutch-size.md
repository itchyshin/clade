...
**What we found (2026-04-15 audit).** Grass sweep × 3 seeds × 600 ticks
reveals a **non-monotone, bell-shaped r/K response** — the richest
theoretical signature in this scenario. Full protocol:
...
prediction**. Above, the population saturates at `max_agents = 500` and
K-selection takes over: single-offspring strategists out- compete
multi-offspring ones, driving evolved clutch to the lower bound. Both

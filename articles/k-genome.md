...
**Audit findings.** This BNN-sigma-from-heterozygosity coupling is the
root cause of the 🔴 Baldwin scenario failure. Tier 5 backlog: decouple
sigma from heterozygosity, allow it to evolve as its own trait. (The
additive expression for ANN/CTRNN/GRN brains works correctly.)

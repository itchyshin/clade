...
The framing follows the canonical structure of *An Introduction to
Behavioural Ecology* (Davies, Krebs & West, Wiley, 4th edition) and
intersects with the cognitive-ecology program laid out in Shettleworth’s
*Cognition, Evolution, and Behavior* (OUP) and the evolutionary-origins
perspective of Godfrey-Smith’s *Other Minds*.
...
| Phenotype–environment-match models (e.g. Burke, Nakagawa & Bonduriansky 2020 on transgenerational plasticity) | Custom NetLogo / Python                                                                                                       | clade’s fitness is emergent from foraging + survival + reproduction, not a fitness function you define. Models where the core mechanic is “match a phenotype to a stress state” don’t fit clade’s design centre.                                             |
...
The three textbooks clade’s framing follows:
...
- Davies, N. B., Krebs, J. R. & West, S. A. (2012). [*An Introduction to
  ...
  4th ed. Wiley. *— The three-pillar structure comes directly from this
  book.*
- Shettleworth, S. J. (2010). [*Cognition, Evolution, and
  ...
  2nd ed. Oxford University Press. *— The cognitive-ecology spine;
  especially useful for interpreting `s-brain-size`,
  `s-social-learning`, `s-rl`, and `s-cephalopod`.*
- Godfrey-Smith, P. (2016). [*Other Minds: The Octopus, the Sea, and the
  ...
  Farrar, Straus and Giroux. *— The deep-origins perspective that partly
  inspired

...
`dev/audit/fidelity/paper_mcelreath_2007.R` (3 horizons × 8 seeds = 24
runs, ~24 min wall-clock). Saved to
`dev/audit/fidelity/paper_mcelreath_2007.rds`. Headline finding: **the
peak-then-decay trajectory disappears at 8 seeds.**
...
finding for the v0.8-core review.
...
Documented as a candidate finding for the v0.8-core review.

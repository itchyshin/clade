---
title: "tick.jl — one tick in the life of an agent"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{tick.jl — one tick in the life of an agent}
...
Source file: [`inst/julia/src/tick.jl`](https://github.com/itchyshin/clade/blob/main/inst/julia/src/tick.jl).
...
in 0.4.0. See [`dev/docs/kernel-0.4.0.md`](https://github.com/itchyshin/clade/blob/main/dev/docs/kernel-0.4.0.md) for the full reasoning.
...
implementations (MATLAB, alifeR R, clade Julia). See the [sense.jl chapter](k-sense.html) for

---
title: "death.jl — when agents die and why"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{death.jl — when agents die and why}
...
Source file: [`inst/julia/src/death.jl`](https://github.com/itchyshin/clade/blob/main/inst/julia/src/death.jl).

...
| Mimicry and toxicity      | `mimicry`                         | Heritable toxicity deters predators via Rescorla–Wagner avoidance learning.                      |
...
The showcase vignette works through a richer set of experiments — combining
multiple modules, comparing brain types, and reading the outputs with the
analysis helpers:

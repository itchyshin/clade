...
See `dev/docs/timescale-analysis.md` for the biological reference
table (E. coli through elephant) and the full MATLAB-ancestor
comparison that motivated these presets.
...
others live in `?default_specs`. Values shown are the 0.4.0 defaults.

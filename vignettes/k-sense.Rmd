---
title: "sense.jl — what an agent perceives"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{sense.jl — what an agent perceives}
...
Source file: [`inst/julia/src/sense.jl`](https://github.com/itchyshin/clade/blob/main/inst/julia/src/sense.jl)
(132 lines).

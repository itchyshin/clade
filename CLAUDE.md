...
- `dev/design/00-vision.md` — vision, lab values, scope, core
  contracts, evidence standard.
- `dev/design/10-after-task-protocol.md` — closure ritual for every
  meaningful task.
- `dev/dev-log/check-log.md` — newest entries describe the latest
  state of main.
...
Then read the newest check-log entry and the latest after-task

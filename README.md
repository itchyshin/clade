...
primary literature (27 of 32 auditable scenarios pass; 5 have
...
predation-neural, stress-hypermutation) have honestly-documented
kernel or ecology limitations. The ledger was confirmed end-to-end
under the 0.5.10 real-diploid-sex kernel — see
[`post_0510_summary.md`](https://github.com/itchyshin/clade/blob/main/dev/audit/fidelity/post_0510_summary.md). See the
